...
namespace NextCash
{
    ...
    public:
        ...
        bool insert(SortedObject *pObject, bool pAllowDuplicates = false);
    ...
    protected:
        ...
        //
        // Sets WAS_FOUND in pFlags if a matching item was found.
        ...
        Iterator moveBackward(Iterator pIterator, const SortedObject &pMatching);
